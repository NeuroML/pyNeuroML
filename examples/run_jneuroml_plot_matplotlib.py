...
if '-noneuron' not in sys.argv:  # To allow skipping of this for ease of testing
    ...
    results2 = pynml.run_lems_with_jneuroml_neuron(example_lems_file, nogui=True, load_saved_data=True, verbose=True)
...
if '-brian2' in sys.argv:  # To allow skipping of this for ease of testing
    ...
    results3 = pynml.run_lems_with_jneuroml_brian2(example_lems_file, nogui=True, load_saved_data=True, verbose=True)
