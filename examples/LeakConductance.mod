...
BREAKPOINT {
    ...
    ? DerivedVariable is based on path: gatesHHrates[*]/fcond, on: Component(id=LeakConductance type=ionChannelHH), from gatesHHrates; null
    ? Path not present in component, using factor: 1
    
    fopenHHrates = 1 
    
    ? DerivedVariable is based on path: gatesHHtauInf[*]/fcond, on: Component(id=LeakConductance type=ionChannelHH), from gatesHHtauInf; null
    ? Path not present in component, using factor: 1
    
    fopenHHtauInf = 1 
    
    ? DerivedVariable is based on path: gatesHHratesTau[*]/fcond, on: Component(id=LeakConductance type=ionChannelHH), from gatesHHratesTau; null
    ? Path not present in component, using factor: 1
    
    fopenHHratesTau = 1 
    
    ? DerivedVariable is based on path: gatesHHratesInf[*]/fcond, on: Component(id=LeakConductance type=ionChannelHH), from gatesHHratesInf; null
    ? Path not present in component, using factor: 1
    
    fopenHHratesInf = 1 
    
    ? DerivedVariable is based on path: gatesHHratesTauInf[*]/fcond, on: Component(id=LeakConductance type=ionChannelHH), from gatesHHratesTauInf; null
    ? Path not present in component, using factor: 1
