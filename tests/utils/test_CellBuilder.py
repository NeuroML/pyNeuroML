...
class CellBuilderTestCase(unittest.TestCase):
    ...
    def test_add_segment(self):
        ...
        new_cell = create_cell(cell_id="test_cell")
        segment = add_segment(
            new_cell, (0, 0, 0, 20), (20, 0, 0, 20), name="soma", group="soma_group"
        )
    ...
    def test_setting_channel_density(self):
        ...
        ion_chan = IonChannel(id="pas", conductance="10 pS", type="ionChannelPassive")
